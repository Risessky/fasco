...
function Arrivals() {
  return (
    <section className="container mx-auto flex flex-col items-center  mt-10 pb-56 ">
      <h2 className="font-volkhov text-[46px] text-grayDark text-center ">New Arrivals</h2>
