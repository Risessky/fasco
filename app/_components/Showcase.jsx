...
function Showcase() {
  ...
  return (
    ...
    >
      {/* ستون اول */}
      <motion.div
        className="relative h-[756px] bg-grayLight max-lg:h-[640px]  rounded-[10px] max-sm:rounded-none max-sm:order-2"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
      ...
      <div className="grid grid-rows-[150px_auto_150px] h-[756px] gap-4 max-lg:h-[640px] ">
        <motion.div
          className=" bg-grayLight relative rounded-[10px] max-sm:rounded-none"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
          variants={imageVariants}
        ...
        <div className="flex flex-col items-center justify-center gap-2 px-4 max-2xl:px-0">
          ...
          <p className="text-grayDark text-[20px] text-center">NEW COLLECTION</p>
          <Button href="shop" styles="mt-4 mb-3">
            SHOP NOW
          </Button>
        </div>

        <motion.div
          className="relative bg-[#B5786E] rounded-[10px]"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
          variants={imageVariants}
      ...
      {/* ستون سوم */}
      <motion.div
        className="relative h-[756px] bg-grayLight max-lg:h-[640px] max-md:hidden rounded-[10px] "
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
        variants={imageVariants}
