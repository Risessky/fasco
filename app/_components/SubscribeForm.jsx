...
function SubscribeForm() {
    return (
        <form className="flex flex-col items-center w-full">
            <input className="w-full max-w-[631px] shadow-[0_20px_35px_0_rgba(0,0,0,0.5)] mb-9  border-grayLight rounded-sm px-6 py-3" type="text" placeholder="micheal@gamil.com"></input>
