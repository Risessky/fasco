    ...
    <div className="absolute left-[-130px] bottom-0 max-md:left-0 max-sm:left-[-17px]">
      <div className="flex gap-4">
        <button
          ...
          className={`w-12 h-12 rounded-full  hover:bg-grayLight text-black  shadow-[0_0_15px_rgba(0,0,0,0.3)] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 ${
